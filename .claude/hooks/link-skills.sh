...
global-skills/compact-backlog
global-skills/fabrica-de-skills
global-skills/project-setup
global-skills/report-gen
global-skills/web-scraper
global-skills/cdp-ui-check
global-skills/layout-lab
global-skills/adb-device
